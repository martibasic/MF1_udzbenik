...
- **T1** — temeljna primjena jedne relacije ili jedne ideje.
- **T2** — standardni zadatak s jednim dominantnim modelom.
- **T3** — zadatak koji traži izbor modela, znaka, geometrije ili spajanje dviju tema.
- **T4** — izazovni zadatak s granicama modela ili jačom interpretacijom.
...
Isti izvor sadržaja generira **mrežno izdanje** (interaktivni prikazi, sklopivi prilozi, hipertekstualne poveznice) i **jedinstvenu tiskanu inačicu**. QR kodovi u tiskanoj inačici vode na iste interaktivne prikaze koji se u mrežnoj inačici otvaraju klikom.
