...
| --- | --- | --- | --- |
| <span class="mf1-ch-ref"><span class="mf1-ch-code">pog. 1</span><span class="mf1-ch-title">Osnove fluida i Pascalov zakon</span></span> | <span class="mf1-signal-chip">ρ / γ / p</span> <span class="mf1-signal-chip">F / A</span> | Miješanje gustoće, specifične težine i tlaka; uključivanje mase posude u masu ulja; zamjena omjera površina omjerom promjera; pretpostavka da porast sile povećava i pomak; izbor pumpe prema samo jednom ograničenju. | Oduzeti masu prazne posude, razlikovati isti tlak od iste sile i provjeriti radnu bilancu. Pri izboru pumpe provjeriti i silu i hod; mjernu podudarnost ograničiti na ispitane uvjete. Razlikovati zajamčene granice od standardne nesigurnosti. Pascalov kvazistatički model ne znači trenutačno širenje tlaka. |
